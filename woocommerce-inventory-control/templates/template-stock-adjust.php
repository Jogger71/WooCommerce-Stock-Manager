...
<td class="column-stock <?php echo $product->managing_stock() ? ( ( $product->get_stock_quantity() == 0 ) ? 'out-of-stock' : 'in-stock' ) : 'not-managing'; ?>">
	<?php echo $product->managing_stock() ? $product->get_stock_quantity() : 'Not Managing Stock'; ?>
</td>
